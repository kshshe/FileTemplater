...
import * as directoriesListSagas from '../features/directories-list/redux/sagas';
...
const featureSagas = [commonSagas, directoriesListSagas, homeSagas, templateSelectSagas];
